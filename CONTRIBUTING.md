...
The [issue tracker](https://github.com/vezel-dev/niru/issues) is where all bug
...
labels can be found [here](https://github.com/vezel-dev/niru/labels), along with
...
[here](https://github.com/vezel-dev/niru/milestones).
...
* The version of Niru being used.
* Information about the host and guest platforms (operating system,
  architecture, etc).
...
[Pull requests](https://github.com/vezel-dev/niru/pulls) are a great way to
...
git clone git@github.com:<your-name>/niru.git
cd niru
# Set up a remote pointing to the upstream repository.
git remote add upstream git@github.com:vezel-dev/niru.git
```
