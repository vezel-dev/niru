...
public sealed class UShiftRightInstruction : Instruction
{
    ...
    internal UShiftRightInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
