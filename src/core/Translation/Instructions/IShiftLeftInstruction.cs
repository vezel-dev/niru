...
public sealed class IShiftLeftInstruction : Instruction
{
    ...
    internal IShiftLeftInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
