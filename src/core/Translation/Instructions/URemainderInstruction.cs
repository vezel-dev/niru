...
public sealed class URemainderInstruction : Instruction
{
    ...
    internal URemainderInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
