...
public sealed class UExtractInstruction : Instruction
{
    ...
    internal UExtractInstruction(BasicBlock block, Range range, Variable result, Variable value)
        : base(block)
    {
    ...
    {
        return $"{Result} = uextract {Range}, {Value}";
    }
}
