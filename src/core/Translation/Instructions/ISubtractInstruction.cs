...
public sealed class ISubtractInstruction : Instruction
{
    ...
    internal ISubtractInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
