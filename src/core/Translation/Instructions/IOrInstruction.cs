...
public sealed class IOrInstruction : Instruction
{
    ...
    internal IOrInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
