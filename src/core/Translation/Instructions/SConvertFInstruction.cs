...
public sealed class SConvertFInstruction : Instruction
{
    ...
    internal SConvertFInstruction(BasicBlock block, MidpointRounding? rounding, Variable result, Variable operand)
        : base(block)
    {
        Check.Enum(rounding);
        Check.Null(result);
