...
public sealed class IRotateLeftInstruction : Instruction
{
    ...
    internal IRotateLeftInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
