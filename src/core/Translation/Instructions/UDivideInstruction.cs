...
public sealed class UDivideInstruction : Instruction
{
    ...
    internal UDivideInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
