...
public sealed class IXorInstruction : Instruction
{
    ...
    internal IXorInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
