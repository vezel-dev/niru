...
public sealed class FNegateInstruction : Instruction
{
    ...
    internal FNegateInstruction(BasicBlock block, Variable result, Variable operand)
        : base(block)
    {
        Check.Null(result);
