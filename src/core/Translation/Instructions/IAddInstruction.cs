...
public sealed class IAddInstruction : Instruction
{
    ...
    internal IAddInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
