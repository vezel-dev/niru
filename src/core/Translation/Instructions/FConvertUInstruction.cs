...
public sealed class FConvertUInstruction : Instruction
{
    ...
    internal FConvertUInstruction(BasicBlock block, MidpointRounding? rounding, Variable result, Variable operand)
        : base(block)
    {
        Check.Enum(rounding);
        Check.Null(result);
