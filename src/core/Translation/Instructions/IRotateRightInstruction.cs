...
public sealed class IRotateRightInstruction : Instruction
{
    ...
    internal IRotateRightInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
