...
public sealed class SShiftRightInstruction : Instruction
{
    ...
    internal SShiftRightInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
