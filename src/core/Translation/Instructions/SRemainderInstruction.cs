...
public sealed class SRemainderInstruction : Instruction
{
    ...
    internal SRemainderInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
