...
public sealed class FMaxInstruction : Instruction
{
    ...
    internal FMaxInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
