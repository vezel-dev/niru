...
public sealed class SDivideInstruction : Instruction
{
    ...
    internal SDivideInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
