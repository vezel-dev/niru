...
public sealed class IMultiplyInstruction : Instruction
{
    ...
    internal IMultiplyInstruction(BasicBlock block, Variable result, Variable left, Variable right)
        : base(block)
    {
        Check.Null(result);
